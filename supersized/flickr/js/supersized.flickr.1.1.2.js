...
(function($){
	...
	switch(options.sort_direction){
		...
		case 4:		//From tags
	    		...
	    		break;
		case 5:		//From user and tags
	    		var flickrURL =  'http://api.flickr.com/services/rest/?format=json&method=flickr.photos.search&api_key=' + options.api_key + '&user_id=' + options.user + '&tags=' + options.tags + '&per_page=' + options.total_slides + '&sort=' + sort_order + '&jsoncallback=?';
	    		break;
	    }
